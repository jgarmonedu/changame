...
class MessagesController extends Controller
{
    ...
    public function fetch(Request $request)
    {
        ...
        if ($totalMessages < 1) {
            $response['messages'] ='<p class="message-hint center-el"><span>Di \'Hola\' y empieza a escribir mensajes</span></p>';
    ...
    public function getContacts(Request $request)
    {
        ...
        if (count($usersList) > 0) {
            ...
            $contacts = '<p class="message-hint center-el"><span>Lista de contactos vacia</span></p>';
        }
    ...
    public function search(Request $request)
    {
        ...
        if($records->total() < 1){
            $getRecords = '<p class="message-hint center-el"><span>Nada que mostrar.</span></p>';
        }
        // send the response
        return Response::json([
            'records' => $getRecords,
